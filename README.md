...
vector-ui-grid-kit is a Lua project for frontend apps. It focuses on this technical goal: Develop a Lua command-oriented project for grid scenarios with bounded scenario files, conflict explanations, and fixture-scale datasets.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 163, risk penalty 6, latency penalty 4, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
